 ...
 * Author: T Carpenter and Arul Prakash Samathuvamani
 *
 * Change Log:
 *
 * Date       | Changes
 * -----------+-------------------------------
 * 02/06/2021 | Creation of initialise driver for 44.1 Khz Sampling Rate
...
signed int WM8731_initialise ( unsigned int base_address ); // Initialise for sampling frequency of 48 Khz

signed int WM8731_initialise_44 ( unsigned int base_address) ; // Initialise for sampling frequency of 44.1Khz
